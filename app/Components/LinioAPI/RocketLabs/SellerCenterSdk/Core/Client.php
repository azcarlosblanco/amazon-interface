<?php
namespace App\Components\LinioAPI\RocketLabs\SellerCenterSdk\Core;

use GuzzleHttp\Psr7\Request;
use App\Components\LinioAPI\RocketLabs\SellerCenterSdk\Core\Http\ClientInterface as HttpClientInterface;
use App\Components\LinioAPI\RocketLabs\SellerCenterSdk\Core\Http\GuzzleClientAdapter;
use App\Components\LinioAPI\RocketLabs\SellerCenterSdk\Core\Request\OutputFormatAdapter\OutputFormatAdapterInterface;
use App\Components\LinioAPI\RocketLabs\SellerCenterSdk\Core\Request\OutputFormatAdapter\XmlOutputFormatAdapter;
use App\Components\LinioAPI\RocketLabs\SellerCenterSdk\Core\Request\RequestInterface;
use App\Components\LinioAPI\RocketLabs\SellerCenterSdk\Core\Request\Signature\HashHmacRequestSignature;
use App\Components\LinioAPI\RocketLabs\SellerCenterSdk\Core\Request\Signature\RequestSignatureProviderInterface;
use App\Components\LinioAPI\RocketLabs\SellerCenterSdk\Core\Request\Timestamp\TimestampFormatter;
use App\Components\LinioAPI\RocketLabs\SellerCenterSdk\Core\Request\Timestamp\TimestampFormatterInterface;
use App\Components\LinioAPI\RocketLabs\SellerCenterSdk\Core\Response\Factory;
use App\Components\LinioAPI\RocketLabs\SellerCenterSdk\Core\Response\ResponseInterface;
...
class Client
{
    ...
    public function call(RequestInterface $request)
    {
        ...
        // $bodyData["Product"][0]["PackageHeight"] = "222";
        // $bodyData["Product"][0]["PackageLength"] = "222";
        // $bodyData["Product"][0]["PackageWidth"] = "222";
        // $bodyData["Product"][0]["PackageWeight"] = "5";
        // $bodyData["Product"][0]["DeliveryTimeSupplier"] = "5";
        ...
        $httpRequest = new Request(
            ...
            $request->getMethod() == Client::POST && !empty($request->getBodyData()) ?
                $this->requestBodyFormatter->convertToOutputFormat($bodyData) : null
        );
