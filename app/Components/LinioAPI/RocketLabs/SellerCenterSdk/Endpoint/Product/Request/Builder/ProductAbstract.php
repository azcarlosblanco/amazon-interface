...
abstract class ProductAbstract extends RequestBuilderAbstract
{
     ...
     * @var int
     */
    protected $deliveryTimeSupplier;
    ...
    /**
     * @param int $deliveryTimeSupplier
     * @return static
     */
    public function setDeliveryTimeSupplier($deliveryTimeSupplier)
    {
        $this->deliveryTimeSupplier = $deliveryTimeSupplier;
        return $this;
    }
