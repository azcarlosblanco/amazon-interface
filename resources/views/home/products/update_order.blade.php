...
<body class="hold-transition login-page" style="background: linear-gradient(to left, #fcd877 , #f8b500)">
<div class="login-box" style="width: 800px">
  <div class="login-logo">
    <a><b>L</b>ARS</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body" style="border: 1px solid rgb(116, 114, 114); padding: 5% 5%;">
